function cadastro() {
  ...
  formCadastro.addEventListener("submit", async (event) => {
    ...
    if (senha !== confirmasenha) {
      document.getElementById("resultado").textContent = "As senhas não coincidem.";
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        document.getElementById("resultado").textContent = data.erro || "Erro ao cadastrar usuário.";
      }
